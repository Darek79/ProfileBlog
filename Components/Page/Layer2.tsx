import { Box, Header, TitleDescImg, ItemBox, PageWrapper } from 'Components';
...
export default function Layer2(): JSX.Element {
    return (
        <PageWrapper
            ...
            boxInnerClasses="bg-pageWhite maxWidthPage pt-20 px-3 sm:px-10 sm:pt-10"
        >
            ...
            <Box className="">
                ...
                <Box className="grid gap-4 w-full grid-cols-1 sm:grid-cols-2">
                    <ItemBox
                        className="pb-10 relative drop-shadow-lg cursor-pointer"
                        imgWrapperProps={{ className: 'relative overflow-hidden w-full h-[25rem]' }}
                        imgProps={{
                            src: prod1,
                            layout: 'fill',
                            objectFit: 'cover',
                    ...
                    />
                    <ItemBox
                        className="pb-10 w-full relative drop-shadow-lg cursor-pointer"
                        imgWrapperProps={{ className: 'relative overflow-hidden w-full h-[400px]' }}
                        imgProps={{
                            src: prod3,
                            layout: 'fill',
                    ...
                    />
                    <ItemBox
                        className="pb-10 relative w-full drop-shadow-lg cursor-pointer"
                        imgWrapperProps={{ className: 'relative overflow-hidden w-full h-[400px]' }}
                        imgProps={{
                            src: prod4,
                            layout: 'fill',
